...
final class ComponentRunWasRemovedEvent implements ComponentRunEventInterface
{
    /**
     * The component run that was removed.
     *
    ...
    /**
     * Create a new component run was removed event instance.
     *
